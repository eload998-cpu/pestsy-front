...
import { ManagementPlanService as CRUDService } from 'src/app/services/administration/management-plan.service';
...
export class TableComponent implements OnInit, OnDestroy {
  ...
  public canShowAction() {
    let arr = [
      this._permissionService.checkPermission('download_management_plan'),
