...
//SERVICES
import { LocationService as CrudService } from 'src/app/services/administration/location.service';
...
export class CreateComponent implements OnInit {
  ...
  constructor(
    ...
    this.form_model = new FormGroup({
      ...
      is_legionella: new FormControl('false'),
  ...
  public async onSubmit(): Promise<void> {
    ...
    try {
      ...
      if (this.form_model.valid) {
        ...
        this.clearForm();
        this.spinner.hide();
        this.toastr.success('Ubicación añadida exitosamente', 'Mensaje');
  ...
  private clearForm(): void {
    this.form_model.get('name').reset('');
    this.form_model.get('is_legionella').reset('false');
