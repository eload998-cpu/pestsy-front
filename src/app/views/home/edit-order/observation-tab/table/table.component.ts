...
export class TableComponent implements OnInit {
  ...
  public async delete(id: number) {
    ...
    if (response.isConfirmed) {
      ...
      this.toastr.success("Observación eliminada.", "Mensaje");
    }
  }
  ...
  public async sortResponsive(attribute: string) {
    ...
    let resp = await this._crudService.index(this.search_input, (this.mobile_asc) ? 'ASC' : 'DESC', attribute, this.page, this.order_id);
