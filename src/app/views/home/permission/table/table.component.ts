...
import { PermissionService as CRUDService } from 'src/app/services/administration/permission.service';
...
export class TableComponent implements OnInit, OnDestroy {
  ...
  public canShowAction() {
    let arr = [
      this._permissionService.checkPermission('download_permission'),
