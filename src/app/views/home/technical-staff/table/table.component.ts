...
import { TechnicalStaffService as CRUDService } from 'src/app/services/administration/technical-staff.service';
...
export class TableComponent implements OnInit, OnDestroy {
  ...
  public canShowAction() {
    let arr = [
      this._permissionService.checkPermission('download_technical_staff'),
