  ...
  ngOnInit(): void {
    ...
    this.route.data.subscribe((data: any) => {
      ...
      this.form_model.patchValue({
        _method: 'PUT',
        common_name: this.model.common_name,
        scientific_name: this.model.scientific_name,
        id: this.model.id,
        is_xylophagus: this.model.is_xylophagus == 1 ? "true" : "false",
  ...
  public async onSubmit(): Promise<void> {
    ...
    try {
      ...
      if (this.form_model.valid) {
        ...
        this.spinner.hide();
        this.toastr.success('Plaga modificada exitosamente', 'Mensaje');
