...
import { faEnvelope, faLocationArrow, faTint } from '@fortawesome/free-solid-svg-icons';
import { faCheckCircle, faCog, faBox, faCaretRight, faCaretDown, faBolt, faObjectGroup, faSuitcase } from '@fortawesome/free-solid-svg-icons';
...
export class MobileSidebarComponent implements OnInit, OnDestroy {
  ...
  public menus: Menu[] = [
    ...
    { step: 27, onlyRole: 'administrator, super_administrator,fumigator' },
